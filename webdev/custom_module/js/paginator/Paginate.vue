<template>
	<div :class="containerClass" v-if="pageCount > 1">
		<div class="catalog-list-next">
			<a v-if="pageCount > 1 && pageCount > selected + 1"
					class="catalog-list-next-btn" @click.prevent="morePage" href="javascript:">Показать еще</a>
		</div>
		<ul v-if="!noLiSurround">
